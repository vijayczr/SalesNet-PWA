...
export default function DARSummary() {
  ...
  async function DarList() {
    ...
    const res = await fetch(`${process.env.REACT_APP_BASE_URL}/Dar/DarList`, {
      method: "POST",
      headers: {
                ...
                <div className="box-footer">
                  <center style={{ padding: "10px" }}>
                    ...
                    <button
                      ...
                      style={{ backgroundColor: "#183985", width: "150px" }}
                    >
                      Incentive Rule
                    </button>
                    ...
                    >
                      ...
                      >
                        <div className="modal-content">
                          ...
                          <div className="modal-body">
                            <p className="pt-0">
                              1. Achievement {">"}= 75 and Achievement {"<"} 76{" "}
                              <br></br> Achievement = 40% <br></br>2.
                              Achievement {">"}= 76 and Achievement {"<"} 86{" "}
                              <br></br>Achievement = 50% <br></br>3. Achievement{" "}
                              {">"}= 86 and Achievement {"<"} 91 <br></br>{" "}
                              Achievement = 70% <br></br>4. Achievement {">"}=
                              91 <br></br>same as Achievement{" "}
                            </p>
