...
import { DatePicker, ConfigProvider, Table, Select, Space, Modal } from "antd";
...
export default function FormQuotation() {
  ...
  async function getQuotPreInfo() {
    const res = await fetch(
      `${localStorage.getItem(
        "BaseUrl"
      )}/ISR/QuotPreInfo?DarId=${searchparams.get("id")}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("JwtToken")}`,
  ...
  async function SubmitQuotationForm() {
    ...
    let pageData = {
      ...
      KindAttention: ContactPerson ? ContactPerson : "",
      Subject: Subject,
              ...
              <div className="ibox-content">
                <div class="box-body">
                  ...
                  >
                    ...
                    <tr>
                      <td style={{ fontSize: "14px" }} align="right">
                        {PreQuotData.todayDate}
                      </td>
                    </tr>
                    <tr>
                      <td
                    ...
                    <tr>
                      <td>
                        <b fontSize="14px">{PreQuotData.custName}</b>
                        <br></br>
                        <b fontSize="14px">{PreQuotData.custAddress}</b>
                        <br></br>
                        <b fontSize="14px">{PreQuotData.custCity}</b>
                        <br></br>
                        <b fontSize="14px">{PreQuotData.custState}</b>
                        <br></br>
                        <b fontSize="14px">
                          {PreQuotData.custCountry} , {PreQuotData.custZip}
                        </b>
                        <br></br>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        At the outset, we thank you for giving us an opportunity
                        to serve your organization. Trident Techlabs Limited is
                        a multifaceted engineering and design solution company
                        with pan India present having partnership with global
                        technology leaders.<br></br>
                    ...
                    <tr>
                      <td>
                        <p>
                          ...
                          consideration at the time of delivery & will have to
                    ...
                    <tr>
                      <td>
                        <p>
                          We sincerely believe that our quotation is in
                          accordance your requirements and will merit your kind
                          approval. However, in case you need any further
                          information or clarification in this regard, please
                      ...
                      <td>
                        ...
                        >
                          <tr>
                            <td>
                              <b>
                                Trident Techlabs Pvt. Ltd.,&nbsp;White House,
                                1/18-20, Rani Jhansi Road, New Delhi - 110055
                                (India)
                              </b>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <b>
                                Tel: +91-11-41118800, +91-11-41118830 Email:
                                delhi@tridenttechlabs.com,
