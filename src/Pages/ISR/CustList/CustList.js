...
export default function CustList() {
  ...
  // run on initial load and whenever table params changes
  useEffect(() => {
    ISRCustList();
  ...
  async function ISRCustList() {
    // data sent along with the call on the api
    let PageData = {
      Search: FilterName,
      Name: CustName, // customer name
      Branch: CustBranch, // customer branch from select tag
      Vertical: CustVertical, // customer vertical from select tag
      pageNumber: tableParams.pagination.current, // pagination state
      pageSize: tableParams.pagination.pageSize, // pagination state
    };
    console.log(PageData);
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/ISR/CustomerList`,
      {
        method: "POST",
        headers: {
          ...
          <div className="col-lg-12">
            <div className="bg-boxshadow">
              <div className="ibox-content">
                <div className="row">
                  {/* customer list inputs */}
                  <div className="col-md-4 mt-3">
                    <div className="d-flex">
                      <label for="inputEmail3" className="col-md-5">
                        Customer Name<span className="float-right">:</span>
                      </label>
                    ...
                    <div className="d-flex">
                      ...
                      <div className="col-md-7">
                        <select
                          ...
                          onChange={(e) => {
                            console.log(e.target.value);
                            setCustVertical(e.target.value);
                          }}
                          style={{ width: "100%" }}
                        >
                          <option value={0}>Select</option>
                ...
                <div className="box-footer">
                  <center style={{ padding: "10px" }}>
                    ...
                    <button
                      ...
                      style={{ backgroundColor: "#06960b", width: "180px" }}
                      onClick={ISRCustList}
                    >
                      Search Customer
                    </button>
