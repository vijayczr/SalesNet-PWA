...
export default function TargetEdit(props) {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    <button type="button" data-toggle="modal" data-target="#exampleModalCenter2" className="viewbutton" style={{ marginRight: "0px" }} ><EditOutlined /> </button>
                        ...
                        <div className="modal-dialog modal-dialog-centered" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="button" className="btn btn-primary" onClick={() => DelTarget(record.empTargetDetailId)}>Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row pt-1 pb-1">
                        ...
                        <div className="col-md-6">
                            <ol className="breadcrumb d-flex justify-content-end bg-transparent">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Employee Target</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="ibox-content">
                                <div className="row">
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1">Financial Year<span style={{ paddingLeft: "50px" }} className="pull-right">:</span></label>
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1">Principal<span style={{ paddingLeft: "50px" }} className="pull-right">:</span></label>
                                            <div className="col-md-7">
                                                <select
                                                    style={{ width: "100%" }}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex mt-3" >
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "150px", fontWeight: "bold" }}>Quarter</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="d-flex mt-3">
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "50px", fontWeight: "bold" }}>Target</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "150px" }}>AMJ</label>
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "150px" }}>JAS</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "150px" }}>OND</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                    ...
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                            <label for="inputEmail3" className="col-md-5 mt-1" style={{ paddingLeft: "150px" }}>JFM</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="d-flex">
                                ...
                                <div className="box-footer">
                                    <center style={{ padding: "10px" }}>
                                        ...
                                        <button className="FunctionButton" style={{ backgroundColor: "#183985" }} onClick={AddTarget} >Submit</button>
