...
export default function HrEmpDesig() {
      ...
      render: (_, record) => (
        <Space size="middle">
          <button
            ...
            onClick={() => ViewEmpPage(record.designationId)}
          >
            <EditOutlined />{" "}
          </button>
          <button
              ...
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    onClick={() => DelEmp(record.designationId)}
                  >
                    Delete
                  </button>
                </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      <label for="inputEmail3" className="col-md-5 mt-1">
                        teamType<span className="pull-right">:</span>
                      </label>
                      <div className="col-md-7">
                        <input
                          placeholder={teamType}
                          className="form-control"
                          disabled
                          readonly
                        />
                  ...
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      <label for="inputEmail3" className="col-md-5 mt-1">
                        Parent<span className="pull-right">:</span>
                      </label>
                      <div className="col-md-7">
                        <select
                          value={parentId}
                  ...
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      <label for="inputEmail3" className="col-md-5 mt-1">
                        isActive<span className="pull-right">:</span>
                      </label>
                      <div className="col-md-7">
                        <input
                          placeholder={
              ...
              <div className="modal-content">
                  ...
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      ...
                      <div className="col-md-7">
                        ...
                        <select
                          value={isActive === true ? "Active" : "In-Active"}
                          onChange={(e) => {
                ...
                <div className="modal-footer">
                  ...
                  <button
                    type="button"
                    className="btn btn-primary"
                    onClick={() => EditDesig(record.designationId)}
                  >
                    Submit
                  </button>
                </div>
  ...
  async function DelEmp(e) {
    const res = await fetch(
      `${localStorage.getItem(
        "BaseUrl"
      )}/HrManual/DeleteDesignation?DesignationId=${e}`,
      {
        method: "GET",
        headers: {
  ...
  async function ViewEmpPage(e) {
    const res = await fetch(
      `${localStorage.getItem(
        "BaseUrl"
      )}/HrManual/ViewDesignation?DesignationId=${e}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("JwtToken")}`,
  ...
  async function AddDesignation1() {
    ...
    if (!DesignName1 || !teamType1 || !parentId1) {
      Modal.error({
        title: "Error",
