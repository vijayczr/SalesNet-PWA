...
import { ConfigProvider, DatePicker, Space, Table, message } from "antd";
      ...
      render: (_, record) => (
        <Space size="middle">
          <button
            ...
            onClick={() => ViewHoliday(record.holidayId)}
          >
            <EditOutlined />{" "}
          </button>
              ...
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  ...
                  <button
                    ...
                    onClick={() => DelHolday(record.holidayId)}
                  >
                    Delete
                  </button>
                </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      <label for="inputEmail3" className="col-md-5 mt-1">
                        Holiday Name<span className="pull-right">:</span>
                      </label>
                  ...
                  <div className="col-lg-12">
                    <div className="form-group d-flex">
                      <label for="inputEmail3" className="col-md-5 mt-1">
                        Branch<span className="pull-right">:</span>
                      </label>
                      <div className="col-md-7">
                        <select
                          value={BranchName1}
                ...
                <div className="modal-footer">
                  ...
                  <button
                    type="button"
                    className="btn btn-primary"
                    onClick={() => EditHoliday(record.holidayId)}
                  >
                    Submit
                  </button>
                </div>
    ...
    try {
        for(let key in PageData) {
            if(PageData[key] === null || PageData[key] === undefined) {
                msgError(`Please fill the ${key} field`); 
                return;
            }
        }
      const res = await fetch(
                  ...
                  <div className="col-lg-4">
                    <div className="d-flex">
                      ...
                      <div className="col-md-7">
                        <input
                          onChange={(e) => {
                            setHolidayName1(e.target.value);
                          }}
                          value={HolidayName1}
                          className="form-control"
                        />
