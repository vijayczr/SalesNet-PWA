...
export default function AddCustForm(PrevData) {
  ...
  useEffect(() => {
    ...
    if (!ignore) getBranchAndVertical();
    ViewCustDetail();
    return () => {
      ignore = true;
    };
  ...
  async function ViewCustDetail() {
    const res = await fetch(
      `${localStorage.getItem("BaseUrl")}/ISR/ViewCustomer?customerId=${
        PrevData.customerId
      }`,
      {
        method: "GET",
  ...
  async function ISRCustList() {
    ...
    const res = await fetch(
      `${process.env.REACT_APP_BASE_URL}/ISR/AddCustomer`,
      {
        method: "POST",
        headers: {
              ...
              <div className="ibox-content">
                <div className="row">
                  ...
                  <div className="col-md-4 mt-3">
                    <div className="d-flex">
                      <label for="inputEmail3" className="col-md-5">
                        Sub-Vertical<span style={{ color: "red" }}>*</span>
                        <span className="float-right">:</span>
                      </label>
                      <div className="col-md-7" style={{ paddingLeft: "10px" }}>
                        <select
                          value={CustSubVertical}
                          onChange={(e) => {
                            console.log(e.target.value);
                            setCustSubVertical(e.target.value);
                          }}
                          style={{ width: "100%" }}
                          disabled={PrevData.FormType == "View"}
                          required
                  ...
                  <div className="col-md-4 mt-3">
                    <div className="d-flex">
                      <label for="inputEmail3" className="col-md-5">
                        Phone2<span className="float-right">:</span>
                      </label>
                      <div className="col-md-7" style={{ paddingLeft: "10px" }}>
                        <input
                          type="text"
                  ...
                  <div className="col-md-4 mt-3">
                    <div className="d-flex">
                      <label for="inputEmail3" className="col-md-5">
                        Fax<span className="float-right">:</span>
                      </label>
                      <div className="col-md-7" style={{ paddingLeft: "10px" }}>
                        <input
                          type="text"
                  ...
                  <div className="col-md-4 mt-3">
                    <div className="d-flex">
                      <label for="inputEmail3" className="col-md-5">
                        E-mail ID<span className="float-right">:</span>
                      </label>
                      <div className="col-md-7" style={{ paddingLeft: "10px" }}>
                        <input
                          type="text"
