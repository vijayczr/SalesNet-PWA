...
export default function AppHeader(props) {
  ...
  const base64Image = `data:image/png;base64, ${localStorage.getItem(
    "userImage"
  )}`;
  ...
  return (
    <div>
      <nav className="navbar cssHead navbar-fixed-top">
        ...
        <div className="d-flex align-items-end mr-5">
          <Popover
            ...
            content={
              <div className="profile-menu" style={{ margin: "-12px" }}>
                  ...
                  <div className="mt-2 row">
                    <div className="col-sm-1">
                      <img
                        ...
                        className="defaultpfp2"
                        alt="../../assets/Default_pfp.svg.png"
                      />
                    </div>
                ...
                <a
                  role="button"
                  className="profile-list--data pt-3 btn popovers"
                ...
                >
                  <div className="profile--list-icon">
                    <SettingOutlined
                      style={{ fontSize: "25px", paddingRight: "20px" }}
                    />
                  </div>
      ...
      <nav
        className="shadow p-2 px-4 navbar-inverse navbar-fixed-top"
        style={{ backgroundColor: "#f3f5f9" }}
      >
        {`${localStorage.getItem("EmpId")}` === "297" ? <DarNavbar /> : null}
        {`${localStorage.getItem("EmpId")}` === "1027" ? <HrNavbar /> : null}
        {`${localStorage.getItem("EmpId")}` === "1040" ? <IsrNavbar /> : null}
      </nav>
      <div
        className="modal fade bd-example1-modal-lg"
        tabIndex="-1"
        role="dialog"
